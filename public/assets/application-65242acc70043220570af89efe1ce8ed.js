...
(function() {
  $(function() {
    var doFirstFadeOut;
    $('[data-tool-box-open]').click(function() {
      var target;
      target = $(this).data("tool-box-open");
      $(this).addClass("hide");
      return $("[data-tool-box='" + target + "']").removeClass("hide");
    });
    $('[data-tool-box-close]').click(function() {
      var target;
      target = $(this).data("tool-box-close");
      $("[data-tool-box='" + target + "']").addClass("hide");
      return $("[data-tool-box-open='" + target + "']").removeClass("hide");
    });
    doFirstFadeOut = true;
    setTimeout(function() {
      if (doFirstFadeOut) {
        return $("#wall-menu").fadeOut();
      }
    }, 4000);
    $("#wall-menu-trigger").hover(function() {
      doFirstFadeOut = false;
      return $("#wall-menu").show();
    }, function() {
      return $("#wall-menu").fadeOut();
    });
